...
const CLAUDE_3_5_HAIKU_MODEL_ID = 'eu.anthropic.claude-3-5-sonnet-20241022-v2:0';
          ...
          statements: [
            ...
            new iam.PolicyStatement({
              ...
              resources: [
                ...
                `arn:aws:bedrock:*:${this.account}:inference-profile/eu.anthropic.claude-3-5-sonnet-20241022-v2:0`,
              ],
            }),
